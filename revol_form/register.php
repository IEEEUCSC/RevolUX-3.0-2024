...
<body style="margin: 0;">
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center">
      ...
      <a href="#counts" class="get-started-btn scrollto">REGISTER</a>
    </div>
  </header><!-- End Header -->
            ...
            <div class="entry-content">
              <div class="col-lg-12 mt-5 ">
                ...
                <div class="php-email-form">
                  ...
                  <div class=" mt-3">
                    <select class="form-control select1" name="university" autocomplete="off" aria-required="true" aria-invalid="false" id="university">
                  ...
                  <div class="text-center"><button type="submit" onclick="register();" style="width: 100%;color:whitesmoke">REGISTER</button></div>
                </div>
          ...
          <div class="sidebar">
            ...
            <div class="sidebar-item recent-posts">
              <div class="post-item clearfix">
                <img src="../assets/img/img/delegatePack/tshirt.png" alt="" style="margin-left:30%">
                <!-- <h4><a href="blog-single.html">Delegate T-shirt</a></h4> -->
                <!-- <time datetime="2020-01-01">Jan 1, 2020</time> -->
              </div>

              <div class="post-item clearfix">
                <img src="../assets/img/img/delegatePack/wristband.png" alt="" style="margin-left:30%">
                <!-- <h4><a href="blog-single.html">Wristband</a></h4> -->
                <!-- <time datetime="2020-01-01">Jan 1, 2020</time> -->
              </div>
